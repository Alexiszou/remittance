/*我的订单*/
	...
	/*普通当日到账文案*/
	var careT0='注意：若实现当日到账，需在当日12:00之前完成支付。<br>8:00-21:00订单，订单有效期至当日22:00；21:00-次日8:00订单，订单有效期至次日8:00，请及时支付。<br>如支付遇到问题，请直接咨询在线客服。预计T+0到账，我们将以短信或邮件形式通知您!';
			        ...
			        success: function(data) {
			        	...
			        	for (var i=0; i < data.length; i++) {
			        		...
			        		if (data[i].FinishFlg==0) {
			        			content+='<div class="ddfk-middle wddd-middle wdddR1">						<div class="ddfk-middleT">							<span>'+data[i].ChName+'</span> 向 <span>'+data[i].EnName+'</span> 汇款 <span>'+data[i].PriceEN+'</span>'+data[i].UnitText+'					</div>						<div class="ddfk-middleB wddd-middleB">							<ul class="flex">								<li class="flex1">订单编号<br>									<span>'+data[i].OrderNo+'</span>								</li>								<li class="flex1">付款金额<br>									<span class="red">'+data[i].PriceCN+'人民币</span>								</li>								<li class="flex1">创建时间<br>									<span>'+format(data[i].CreatedTime.time)+'</span>								</li>								<li class="flex1"><div class="btn" id='+data[i].OrderNo+' onclick="ddxqF(this)">查看订单详情</div></li>							</ul>						</div>						<div class="ddfk-top wddd-top">							<div class="ddfk-line">								<div class="ddfk-lineC"></div>							</div>							<ul class="flex">								<li class="flex1">提交订单</li>								<li class="flex1">等待付款</li>								<li class="flex1 cur">付款成功<br><span class="red">订单失效</span></li>								<li class="flex1 cur">已成功到账<br><span class="red">订单失效</span></li>							</ul>						</div>						<div class="ddfk-bot wddd-bot">							<div class="text">'+careStyle+'</div>							<div class="clear btnBox1"><div onclick="jxfkF(this)" class="btnL fr" id='+data[i].OrderNo+'>继续付款</div></div>						</div>					</div>'

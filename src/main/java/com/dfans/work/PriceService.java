...
public class PriceService {
	...
	public void exchange() {
		...
		// 获取高汇通汇率数据
		param = getGHTrate();
		priceMapper.updatePrice(param);

	}

	// 1.人民币牌价
	public static Map<String, String> getGHTrate() {
		Merchant merchant = Merchant.T0;
		Map<String, String> map = new HashMap();
		String result = null;
		// String url = "http://web.juhe.cn:8080/finance/exchange/rmbquot";//
		// 请求接口地址
		String url = BootUtil.getPro("payurl");
		//String url = "https://testpay.sicpay.com/entry.do";
		Map<String, Object> params = new LinkedHashMap<String, Object>();// 请求参数
		params.put("busi_code", "SEARCH_RATE");// APP Key
		params.put("merchant_no", merchant.getMerchant());
		params.put("sign_type", "SHA256");
		params.put("terminal_no", merchant.getTerminal());
		params.put("key",merchant.getKey());
		System.out.println("params:"+BootUtil.urlencode_cn(params));
		String sign = SHA256Utils.SHA256Encode(BootUtil.urlencode_cn(params),"UTF-8").toLowerCase();
